...
public class StructurePlacementManager : MonoBehaviour
{
    ...
    public GameObject advancedServiceCenterPrefab;   // NEW: Advanced Service Center
    ...
    public GameObject advancedBusinessCenterPrefab;  // NEW: Advanced Business Center
    ...
    void PlaceStructure()
    {
        ...
        GameObject realStructure = Instantiate(
            currentPrefab,
            hoveredTile.transform.position + Vector3.up * 1f,
            Quaternion.identity
        );
